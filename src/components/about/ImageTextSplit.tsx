  ...
  return (
    <Section spacing="none" className="bg-[#151515] relative overflow-hidden border-t border-border/10">
      <div className="flex flex-col lg:flex-row min-h-[70vh]">
        ...
        <div className="w-full lg:w-1/2 relative overflow-hidden min-h-[400px] lg:min-h-full group">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-16 lg:p-24 relative z-20">
          <motion.div
          ...
          >
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif text-foreground uppercase tracking-tight leading-[1.1] mb-12">
              We believe good marketing should be <span className="text-accent italic font-light">felt</span>, not just seen.
            </h2>
            
            <Link 
              href="/work"
              className="group inline-flex items-center gap-4 text-sm font-bold uppercase tracking-[0.2em] text-foreground hover:text-accent transition-colors"
            >
